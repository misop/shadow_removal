...
\odrazka[1]{2D chromaticity colour space $\{log(G/R), log(B/R)\}$ \TODO chromaticity2}
\odrazka[3]{Zmena v osvetlení v praxi zodpovedá posunu v chromatickom priestore jedným smerom (za predpokladu jedného zdroju svetla)}
\odrazka[4]{Hľadáme orientáciu pixelov v chromatickom priestore}
\uncover<2->{\includegraphics[width=.9\linewidth]{./img/chromaticity_example}}
\end{frame}
